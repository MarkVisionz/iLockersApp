    ...
    <FiltersContainer>
      <SearchFilterItem>
        <SearchWrapper>
          ...
          <SearchInput
            type="text"
            placeholder="Nombre, tipo, precio o ID"
            value={searchQuery}
              ...
              <FilterItem>
                ...
                <SortWrapper>
                  <SortSelect
                    ...
                    aria-label="Ordenar servicios por"
                  >
                  ...
                  <SortButton
                    ...
                    aria-label={`Orden ${sortConfig.direction === "ascending" ? "ascendente" : "descendente"}`}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
...
const ToggleFiltersButton = styled(motion.button)`
  padding: 0.5rem;
  font-size: 0.9rem;
  background: #007bff;
  color: white;
